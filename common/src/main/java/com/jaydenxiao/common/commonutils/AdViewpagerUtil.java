...
public class AdViewpagerUtil {
    ...
    public AdViewpagerUtil(Context context, ViewPager viewPager, int size) {
        this.context = context;
        this.viewPager = viewPager;
        this.size = size;
        startLoopViewPager();
...
//                imageView.setImageResource(R.mipmap.home_page_banner_carousel_trigger);
            } else {
        ...
        public void run() {
            ...
            if (viewPager.getChildCount() > 0) {
                ...
                if (imgsize != 0) {
                    ...
                    viewPager.setCurrentItem(autoIndex % size, true);
                }
            }
        }
    };
