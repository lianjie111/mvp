...
public class LSlideButton extends View {
	 ...
	 * 打开状态的背景色
	 */
	private int onColor = Color.parseColor("#0163DE");
	/**
	 * 按钮颜色
	 */
	...
	public LSlideButton(Context context, AttributeSet attrs, int defStyleAttr) {
	...
	public LSlideButton(Context context, AttributeSet attrs) {
	...
	public interface SlideButtonViewListener {
		public void SlideButtonOnClick(LSlideButton SlideButtonView, boolean isOpen);
	}
