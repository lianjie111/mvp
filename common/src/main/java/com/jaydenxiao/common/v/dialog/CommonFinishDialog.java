...
public class CommonFinishDialog extends Dialog {
	...
	public CommonFinishDialog(Context context) {
		super(context);
	}

	public CommonFinishDialog(Context context, int theme) {
		super(context, theme);
	}
	...
	public static class Builder {
		...
		public CommonFinishDialog create() {
			LayoutInflater inflater = (LayoutInflater) context
					.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
			// instantiate the dialog with the custom Theme
			final CommonFinishDialog dialog = new CommonFinishDialog(context, R.style.Dialog);
