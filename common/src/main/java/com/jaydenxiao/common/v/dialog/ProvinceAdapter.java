...
public class ProvinceAdapter extends BaseAdapter {
    ...
    //private List<ProvinceModel> plist;

    private ThreeDictEntity cities;
    ...
    public ProvinceAdapter(Context context, PlistEntity plist) {
        this.context = context;
        this.group = plist.dictentity.get(0);
        this.mInflater = LayoutInflater.from(context);

    }

    public ProvinceAdapter(Context context, ThreeDictEntity cities, boolean flag) {
        this.context = context;
        this.cities = cities;
        this.flag = flag;
        this.mInflater = LayoutInflater.from(context);
    ...
    public int getCount() {
        ...
        return flag ? group.dict.size() : cities.string.size();
    }

    @Override
    public Object getItem(int position) {
        // TODO Auto-generated method stub
        return flag ? group.dict.size() : cities.string.get(position);
    }
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (flag) {
            viewHolder.ProvinceItem.setText(group.dict.get(position).string);
        } else {
            viewHolder.ProvinceItem.setText(cities.string.get(position));
        }
