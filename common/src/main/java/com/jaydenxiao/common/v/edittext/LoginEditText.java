...
public class LoginEditText extends AppCompatEditText  {
    ...
    //按钮资源
    private final int CLEAR = R.mipmap.login_button_delete;
    //动画时长
    ...
    public LoginEditText(final Context context, final AttributeSet attrs, final int defStyleAttr) {
...
//                            setText(str1);
//                            setSelection(str1.length());//光标移到最右边
//                        }
//                    }
//                }
//            }
